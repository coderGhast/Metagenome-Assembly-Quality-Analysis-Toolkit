...
FR4 `To confirm if a GC window is outside of the mean by misalign, Open Reading Frame (ORF) Locations should be found where the GC content would naturally be higher in protein coding regions.'
...
FR6 `The application should compare the contiguous read data to known reference data in the NCBI database with BLAST.'
...
FR8 `A user should be able to see the contiguous reads listed in their FASTA data.'
